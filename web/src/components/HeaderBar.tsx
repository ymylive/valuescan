...
import { Menu, X, ChevronDown, Server as ServerIcon } from 'lucide-react'
            ...
            {isLoggedIn ? (
              ...
              <>
                ...
                >
                  ...
                  {t('signalsNav', language)}
                </button>

                <button
                  onClick={() => {
                    if (onPageChange) {
                      onPageChange('simulation')
                    }
                    navigate('/simulation')
                  }}
                  className="text-sm font-bold transition-all duration-300 relative focus:outline-2 focus:outline-yellow-500"
