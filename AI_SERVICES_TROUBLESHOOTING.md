...
AI_LEVELS_API_KEY = "sk-gemini"
AI_LEVELS_API_URL = "https://chat.cornna.xyz/studio/v1/chat/completions"
AI_LEVELS_MODEL = "gemini-3-flash-preview"
```
...
### 2. 手动测试AI API
```bash
curl -X POST https://chat.cornna.xyz/studio/v1/chat/completions \
