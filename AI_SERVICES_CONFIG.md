...
**环境变量** (可选):
```bash
export VALUESCAN_AI_LEVELS_ENABLED=0
export VALUESCAN_AI_LEVELS_API_KEY=sk-gemini
export VALUESCAN_AI_LEVELS_API_URL=https://chat.cornna.xyz/studio/v1/chat/completions
export VALUESCAN_AI_LEVELS_MODEL=gemini-3-flash-preview
```
...
```json
{
  "enabled": true,
  "api_key": "sk-gemini",
  "api_url": "https://chat.cornna.xyz/studio/v1/chat/completions",
  "model": "gemini-3-flash-preview",
  "interval_hours": 1.0,
  "lookback_hours": 1.0
}
...
|------|---------|---------|-------|
| AI主力关键位 | studio/v1 | sk-gemini | gemini-3-flash-preview |
| AI简评 | studio/v1 | sk-gemini | gemini-3-flash-preview |
| 市场分析 | studio/v1 | sk-gemini | gemini-3-flash-preview |
